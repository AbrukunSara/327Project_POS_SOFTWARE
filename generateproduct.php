	...
	<div class="main">
						...
						<div class="input-group">
							<div class="selectOpt">
								<select name="brand_" id="selectId">
									...
									<?php
										$brand_sql="SELECT * FROM dorypos_brand ORDER BY brand_title ASC";
        ...
        $date=dateinfo();
				...
				elseif(empty($_POST['name_']) ||  empty($barcode)  || $_POST['category_']==NULL  || $_POST['brand_']==NULL )
					{
						...
						$add_product="INSERT INTO dorypos_product (p_id,name,barcode,cost,price,in_quantity,quantity,category_id,brand_id,comment,created_date) VALUES (NULL,'$name','$barcode',$cost,$sale,$quantity,$quantity,$category_pick,$brand_pick,'$comment','$date')";
            ...
            $_SESSION['makeBarcode'] = $barcode;
             ...
             header("Location: iprint.php?code=".$_SESSION['makeBarcode']);
					}
					}
