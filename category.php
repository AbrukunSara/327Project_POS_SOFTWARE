        ...
        <?php
          ...
          if (isset($_POST['add_category'])) {
            if (empty($_POST['category_'])) {
              $error="Please Fillout Categorey Name!" ?>
              ...
              $add_category="INSERT INTO dorypos_category (category_id,category_title)VALUES (NULL,'$category')";
              $category_run=mysqli_query($db,$add_category);
              if ($category_run) {
                $error="Categorey Added!" ?>
      					<script>swal("Success","<?php echo $error; ?>", "success");</script> <?php
              }
              else {
                $error="Categorey Added Failed!" ?>
        ...
        <div class="col-md-5 col-xm-5  col-sm-5 right-table ">
          <div id="table-wrapper">
            ...
            <div id="table-scroll">
              ...
              <?php
                $show_categorey="SELECT category_title FROM dorypos_category ORDER BY category_id desc";
                $show_result=mysqli_query($db,$show_categorey);
