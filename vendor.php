    ...
    <div class="container" style="margin-top:6%">
      <div class="row">
        ...
        <script>swal("Opss.....","<?php echo $error; ?>", "error");</script> <?php
          ...
          $add_vendor="INSERT INTO dorypos_vendor (vendor_id,vendor_name,vendor_phone,vendor_address,vendor_brand)VALUES (NULL,'$vendor_name',$vendor_phone,'$vendor_address',$brand)";
                  ...
                  if (mysqli_num_rows($vendor_record)>0) {
                    while ($vendor_result=mysqli_fetch_assoc($vendor_record)) {
                      ...
                      <tr>
                        ...
                        <td><?php
                        $sql="SELECT * FROM dorypos_brand WHERE brand_id={$vendor_result['vendor_brand']} ";
